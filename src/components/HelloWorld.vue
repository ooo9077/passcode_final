<template>
  <div style="background: #0984BD;">
    ...
    <div class="qrcanvas">
        ...
        <div style="color:#1E9243;font-size:160%;position:relative;display: inline-block;font-weight:bold">{{currentdate}}</div>
        <div style="color:#1E9243;font-size:250%;position:relative;display: inline-block;font-weight:bold">{{currentsec}}</div>
        <div style="color:#1E9243;font-size:160%;position:relative;display: inline-block;font-weight:bold">{{currenthour}}</div>
        </div>
        <br>
